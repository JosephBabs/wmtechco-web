<template>
    <section class="contact-area">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="contact-map-area">
              <h2 class="text-dark">({{  pack_name }}) PACK OF SERVICES PURCHASE</h2>
                    ...
                    <div class="col-lg-12">
                      <div class="section-title">
                        <div class="subtitle-content">
                          ...
                          <h5 class="text-light">Purchase this Pack of Services</h5>
                        </div>
        ...
        <div class="alert success-a" v-if="showAlert_s">
          Your order of {{ pack_name }} was successfully placed <br>An Email has been sent to the email address provided in the form
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      async  submitData() {
            const apiLink = dataT.apiUrl.packs_checkout_api_link;
            const url = apiLink;
            const data = {
    ...
    try {
      ...
      getTot(){
        ...
        this.total_due =  this.$route.query.pack_price ?? "00.00"
        this.pack_name = this.$route.query.pack_name ?? "loading..."
        this.pack_price = this.$route.query.pack_price ?? "loading..."
      },
      changeQty() {
        // Handle country change
        const price = this.pack_price
